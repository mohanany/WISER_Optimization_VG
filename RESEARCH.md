...
* $ c_i$ and $Q_{i,j}$ are linear and quadratic coefficients from the QUBO, respectively. A penalty term $M \sum (constraints) is added, with $M = 5-10$ recommended by \[5\] for 95% accuracy.
